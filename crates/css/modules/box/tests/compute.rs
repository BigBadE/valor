#![allow(
    clippy::unwrap_used,
    reason = "Intentional in simple unit test assertions"
)]
#![allow(
    clippy::missing_panics_doc,
    reason = "Test does not define functions that panic by contract"
)]
#![allow(
    clippy::tests_outside_test_module,
    reason = "This is a standalone test crate file"
)]
