...
<!-- BEGIN VERBATIM SPEC: DO NOT EDIT BELOW. This block is auto-generated by scripts/vendor_css22_chapters.sh -->
...
**Code locations:**
- `src/8_*/` - Implementation files for this chapter

**Test fixtures:**
- `tests/fixtures/` - Test HTML/CSS files

**Notes:**
- This chapter is part of CSS 2.2 core specification
- Implementation is integrated with Valor's layout engine

**Spec URL:** https://www.w3.org/TR/CSS22/box.html
