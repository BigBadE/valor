...
**Overall Status:** [Selectors Level 3 - Pattern matching for CSS:Production]
...
cargo test --package css_selectors

# Run specific test
cargo test --package css_selectors test_name
```
...
- `src/matching.rs`: Right-to-left selector matching algorithm
- `src/specificity.rs`: Specificity calculation
- `src/parser.rs`: Selector parsing
