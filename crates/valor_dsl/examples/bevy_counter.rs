...
use valor_dsl::{bevy_events::*, bevy_integration::*, click_handler, html};
...
fn setup(mut commands: Commands) {
    ...
    let ui_html = html! {
        ...
        <body>
            ...
            <p>Click the buttons to trigger Bevy observer systems!</p>
        </body>
        </html>
        "#
    };
