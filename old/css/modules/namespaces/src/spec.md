# namespaces Module - Chapter Specification
...
<div class=head>
  ...
  <h2 class="no-num no-toc no-ref heading settled heading" id=subtitle><span class=content>W3C Recommendation 29 September 2011, edited in place
...
<dl><dt>This version:<dd><a class=u-url href="https://www.w3.org/TR/2014/REC-css-namespaces-3-20140320/">http://www.w3.org/TR/2014/REC-css-namespaces-3-20140320/</a><dt>Latest version:<dd><a href="https://www.w3.org/TR/css-namespaces-3/">http://www.w3.org/TR/css-namespaces-3/</a><dt>Editor’s Draft:<dd><a href=http://dev.w3.org/csswg/css-namespaces/>http://dev.w3.org/csswg/css-namespaces/</a><dt>Previous version:<dd><a href="https://www.w3.org/TR/2011/REC-css3-namespace-20110929/" rel=previous>http://www.w3.org/TR/2011/REC-css3-namespace-20110929/</a>
    <dt>Feedback:</dt>
        <dd><a href="mailto:www-style@w3.org?subject=%5Bcss-namespaces%5D%20feedback">www-style@w3.org</a>
            with subject line
            “<kbd>[css-namespaces] <var>… message topic …</var></kbd>”(<a href=http://lists.w3.org/Archives/Public/www-style/ rel=discussion>archives</a>)<dt>Test Suite:<dd><a href=http://test.csswg.org/suites/css3-namespace/20090210/>http://test.csswg.org/suites/css3-namespace/20090210/</a><dt>Editors:
...
<dd class="p-author h-card vcard"><span class="p-name fn">Anne van Kesteren</span> (<span class="p-org org">Opera Software ASA</span>)<dd class="p-author h-card vcard"><span class="p-name fn">Peter Linss</span> (<span class="p-org org">Netscape Communications</span>)<dd class="p-author h-card vcard"><span class="p-name fn">Chris Lilley</span> (<span class="p-org org">W3C</span>)</dl>

  <p>Please check the <a href="https://www.w3.org/Style/2011/REC-css3-namespace-20110929-errata.html"><strong>errata</strong></a>
  for any errors or issues reported since publication.
  See also <a href="https://www.w3.org/2003/03/Translations/byTechnology?technology=css3-namespace"><strong>translations</strong></a>.
...
technical report can be found in the <a href="https://www.w3.org/TR/">W3C technical reports index at http://www.w3.org/TR/.</a></em></p>

<p>This document was produced by the <a href="https://www.w3.org/Style/CSS/members">CSS Working Group</a> as a
<a href="https://www.w3.org/Consortium/Process/tr#RecsW3C">Recommendation.</a></p>
...
>archived</a>) public mailing list <a
href="mailto:www-style@w3.org?Subject=%5Bcss-namespaces-3%5D%20PUT%20SUBJECT%20HERE"
>www-style@w3.org</a> (see <a href="https://www.w3.org/Mail/Request">instructions</a>). When sending e-mail, please put the text
&#8220;css-namespaces-3&#8221; in the subject, preferably like this:
&#8220;[<!---->css-namespaces-3<!---->] <em>&hellip;summary of
comment&hellip;</em>&#8221;</p>

<p>This document was produced by a group operating under the <a href="https://www.w3.org/Consortium/Patent-Policy-20040205/">5&nbsp;February 2004 W3C Patent Policy</a>. W3C maintains a <a rel="disclosure" href="https://www.w3.org/2004/01/pp-impl/32061/status">public list of any patent disclosures</a> made in connection with the
deliverables of the group; that page also includes instructions for
disclosing a patent.</p>

<p>For details of the changes since the previous version, see the <a
href="#changes">Changes</a> section.
...
<p>A document or implementation cannot conform to CSS Namespaces alone,
  ...
  <dl>
    <dt><dfn data-dfn-type=dfn data-noexport="" id=style-sheet>style sheet<a class=self-link href=#style-sheet></a></dfn></dt>
      <dd>A <a href="https://www.w3.org/TR/CSS21/conform.html#style-sheet">CSS style
    ...
    <dt><dfn data-dfn-type=dfn data-noexport="" id=interpreter>interpreter<a class=self-link href=#interpreter></a></dfn></dt>
      <dd>Someone or something that interprets the semantics of a style sheet.
        (CSS <a href="https://www.w3.org/TR/CSS21/conform.html#user-agent">user
...
<p>		The <a data-link-type=dfn href="https://www.w3.org/TR/selectors4/#type-selector" title="type selectors">type selectors</a>
		<code>elem</code>,
		<code>|elem</code>,
...
<p>	The <span class=css data-link-type=maybe title=@namespace>@namespace</span> <a data-link-type=dfn href="https://www.w3.org/TR/css3-syntax/#at-rule" title=at-rule>at-rule</a> declares a namespace prefix
...
<p>	The syntax for the <span class=css data-link-type=maybe title=@namespace>@namespace</span> rule is as follows
	(using the notation from the <a href="https://www.w3.org/TR/CSS21/grammar.html">Grammar appendix of CSS 2.1</a> <a data-biblio-type=normative data-link-type=biblio href=#css21 title=css21>[CSS21]</a>):
...
<p>	A syntactically invalid <span class=css data-link-type=maybe title=@namespace>@namespace</span> rule
	...
	A CSS <a href="https://www.w3.org/TR/CSS21/conform.html#style-sheet">style sheet</a> containing an invalid <span class=css data-link-type=maybe title=@namespace>@namespace</span> rule
...
<p>	The syntax for the portion of a CSS qualified name before the local name is given below,
	...
	(The syntax uses notation from the <a href="https://www.w3.org/TR/CSS21/grammar.html">Grammar appendix of CSS 2.1</a>. <a data-biblio-type=normative data-link-type=biblio href=#css21 title=css21>[CSS21]</a>
...
<p>	Changes made since the <a href="https://www.w3.org/TR/2011/REC-css3-namespace-20110929/">29 September 2011 Recommendation</a>:
	<ul>
...
<div data-fill-with=normative-references><dl><dt id=css21 title=CSS21><a class=self-link href=#css21></a>[CSS21]<dd>Bert Bos; et al. <a href="https://www.w3.org/TR/2011/REC-CSS2-20110607">Cascading Style Sheets Level 2 Revision 1 (CSS 2.1) Specification</a>. 7 June 2011. W3C Recommendation. URL: <a href="https://www.w3.org/TR/2011/REC-CSS2-20110607">http://www.w3.org/TR/2011/REC-CSS2-20110607</a><dt id=rfc2119 title=RFC2119><a class=self-link href=#rfc2119></a>[RFC2119]<dd>S. Bradner. <a href=http://www.ietf.org/rfc/rfc2119.txt>Key words for use in RFCs to Indicate Requirement Levels</a>. URL: <a href=http://www.ietf.org/rfc/rfc2119.txt>http://www.ietf.org/rfc/rfc2119.txt</a><dt id=xml-names title=XML-NAMES><a class=self-link href=#xml-names></a>[XML-NAMES]<dd>Tim Bray; et al. <a href="https://www.w3.org/TR/2009/REC-xml-names-20091208/">Namespaces in XML 1.0 (Third Edition)</a>. 8 December 2009. W3C Recommendation. URL: <a href="https://www.w3.org/TR/2009/REC-xml-names-20091208/">http://www.w3.org/TR/2009/REC-xml-names-20091208/</a></dl></div>
...
**Spec URL:** https://www.w3.org/TR/css-namespaces-3/
